...
public class SessionBean implements Serializable, Subject {
    ...
    public String go(String page) {
        if (page.equals("validarBonosCliente")) {
            active = "requisiciones";
            ruta = "/Inicio";
            return "/pages/BonosValidarClienteView.xhtml";
        }
        ...
        if (page.equals("configuracionInvRegalo")) {
            active = "regalos";
            ruta = "/Inicio";
            return "/pages/ConfiguracionInventarioRegalos.xhtml";
        }if (page.equals("verRegalos")) {
            active = "regalos";
            ruta = "/Inicio";
            return "/pages/CrudRegalosView.xhtml";
        }if (page.equals("ListaTransferenciasBarajas")) {
            active = "barajas";
            ruta = "/Inicio";
            return "/pages/ListaTransferenciasBarajas.xhtml";
        ...
        }if (page.equals("entregaObsequios")) {
            active = "reportes";
            ruta = "/Inicio";
            return "/pages/ReporteGestionEntregaRegalos.xhtml";
        }if (page.equals("ReporteJustificacionBonos")) {
            active = "reportes";
            ruta = "/Inicio";
            return "/pages/ReporteBonosCasosEspeciales.xhtml";
        }
        ...
        }else if (page.equals("IndicadorConsumoBarajas")) {
            active = "reportes";
            ruta = "/Clientes/Cleintes";
            return "/pages/IndicadoresConsumoBarajas.xhtml";
        } else if (page.equals("reporteseventos")) {
            active = "reportes";
            ruta = "/Reportes/Eventos";
            return "/pages/Reporteeventos.xhtml";
        }else if (page.equals("reportesbonosUtilizados")) {
            active = "reportes";
            ruta = "/Reportes/Eventos";
            return "/pages/ReporteBonosUtilizados.xhtml";
        }else if (page.equals("ReporteBonosMovimientoMensual")) {
            active = "reportes";
            ruta = "/Reportes/Eventos";
