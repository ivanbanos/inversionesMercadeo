...
@NamedQueries({
    ...
    @NamedQuery(name = "Acceso.findByNombre", query = "SELECT a FROM Acceso a WHERE a.nombre = :nombre")})
public class Acceso implements Serializable {
    ...
    @ManyToMany(mappedBy = "accesoList")
    ...
    public Acceso(Integer id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    public String toString() {
        return "com.invbf.sistemagestionmercadeo.entity.Acceso[ id=" + id + " ]";
    }
