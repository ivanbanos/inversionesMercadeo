...
public class Bodega implements Serializable {
    ...
    private List<Casino> casinosList;
    ...
    public String toString() {
        return "com.invbf.sistemagestionmercadeo.entity.Bodega[ id=" + id + " ]";
    }

    @XmlTransient
    public List<Casino> getCasinosList() {
        return casinosList;
    }

    public void setCasinosList(List<Casino> casinosList) {
        this.casinosList = casinosList;
    }
